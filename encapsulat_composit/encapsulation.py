''' Encapsulation: Python allows you to control access to attributes with the built-in
 property() function and corresponding decorator @property.'''
...
class Tank:
    ...
    # the getter method is decorated with '@property'. It designates the name of the 
    # attribute to be used by the external code;
    @property
    def level(self):
        return self.__level

    # the setter method is decorated with '@name.setter'. The method name should be the
    # attribute name
    @level.setter
    ...
    # the deleter method is decorated with '@name.deleter'. The method name should should be
    # the attribute name.
    @level.deleter
    def level(self):
        if self.__level > 0:
