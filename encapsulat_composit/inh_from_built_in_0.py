''' Example on how composition works'''

# Car class is loosely coupled with the “engine” component. It’s a composite object.
class Car:
    def __init__(self, engine):
        self.engine = engine      # can instantiate a class in this property
...
''' Example of inheritance AND compsition'''
class Base_Computer:
